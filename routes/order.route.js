...
router.put('/contract', asyncWrap(mw.authMiddleware), asyncWrap(orderCtl.putOrderContract));
router.get('/contract', asyncWrap(mw.authMiddleware), asyncWrap(orderCtl.findOrderContract));
