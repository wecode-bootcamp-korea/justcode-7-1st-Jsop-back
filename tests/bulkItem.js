const items = [
  ...
  },
  {
    ...
    "img_url": "test.png",
    "description": "진한 메이크업도 부드럽고 깨끗하게 닦아주는 오일 타입의 클렌저",
    "price": [["200 mL", 65000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "클렌저"
    ...
    "properties" : [
      ...
      {"type": "주요 성분", "values": ["마카다미아 씨", "토코페롤", "베타 카로틴"]}
    ]
  },
  {
    "title": "퓨리파잉 페이셜 크림 클렌저",
    "img_url": "test.png",
    "description": "가벼운 메이크업을 지워주고, 피부에 남은 잔여물을 말끔하게 씻어내어 피부를 부드럽고 촉촉하게 가꿔 주는 크림 클렌저",
    "price": [["100 mL", 40000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "클렌저"
  ...
  },
  {
    ...
    "img_url": "test.png",
    "description": "진한 메이크업도 부드럽고 깨끗하게 닦아주는 오일 타입의 클렌저",
    "price": [["100 mL", 35000], ["200 mL", 55000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "클렌저"
    },
    "properties" : [
      ...
      {"type": "주요 성분", "values": ["베르가모트 오일", "캐모마일 꽃 오일", "로즈마리잎"]}
    ]
  },
  {
    ...
    "price": [["100 mL", 45000], ["200 mL", 69000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "클렌저"
    },
    "properties" : [
      ...
      {"type": "주요 성분", "values": ["스페인감초뿌리추출물", "락틱애씨드", "양까막까치밥나무씨오일"]}
    ]
  },
  {
    "title": "어메이징 페이스 클렌저",
    "img_url": "test.png",
    "description": "부드러운 거품이 피부를 효과적으로 세정하고 피부의 균형을 잡아주는 데일리 클렌저",
    "price": [["100 mL", 35000], ["200 mL", 55000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "클렌저"
    ...
    "properties" : [
      {"type": "피부 타입", "values": ["지성", "복합성", "덥고 습한 날씨의 피부"]},
  ...
  },
  {
    ...
    "img_url": "test.png",
    "description": "각질을 관리해주면서 피부를 매끄럽게 클렌징 해주는 크림 베이스 클렌저",
    "price": [["75 mL", 62000]],
    "category" : {
      "level_1_category": "스킨 케어",
    ...
    "properties" : [
      {"type": "피부 타입", "values": ["중성", "건성", "민감성", "여행이 잦거나", "추운 날씨의 피부"]},
  ...
  },
  {
    ...
    "img_url": "test.png",
    "description": "티 트리 리프, 너트 쉘, 클레이를 함유한 파우더 타입의 각질 관리제",
    "price": [["30 mL", 43000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "각질 제거"
  ...
  },
  {
    ...
    "img_url": "test.png",
    "description": "파슬리 씨드와 로즈힙 열매오일 추출물이 함유된 클레이 베이스의 딥 클렌징 마스크로 피부의 잔여물을 효과적으로 세정하며 피부의 수분감을 유지시켜줍니다.",
    "price": [["60 mL", 55000]],
    "category" : {
      "level_1_category": "스킨 케어",
    ...
    "properties" : [
      ...
      {"type": "주요 성분", "values": ["파슬리 씨드(화이트 크레이)", "이브닝 프림로즈쉘", "로즈힙 열매오일"]}
    ]
  },
  {
    "title": "프림로즈 페이셜 클렌징 마스크",
    "img_url": "test.png",
    "description": "식물성 오일이 피부에 영양분을 공급하는 동시에, 잔여물을 깨끗이 씻어내어 상쾌함을 더하는 클레이 타입의 클렌징 마스크",
    "price": [["60 mL", 43000], ["120 mL", 65000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "트리트먼트 & 마스크"
    },
    "properties" : [
      {"type": "피부 타입", "values": ["중성", "건성", "지성", "복합성", "문제성 피부"]},
      {"type": "사용감", "values": ["매끄럽고 깊은 세정"]},
      {"type": "주요 성분", "values": ["포도 씨(로즈 힙)", "판테놀(프림로즈)", "파슬리 씨앗(실비아오일)"]}
    ]
  },
  {
    "title": "컨트롤",
    ...
    "properties" : [
      ...
      {"type": "주요 성분", "values": ["파나이아신아마이드", "소듐 아스코빌 포스페이트", "살리실릭애씨드"]}
    ]
  },
  {
    "title": "카모마일 컨센트레이트 안티 블레미쉬 마스크",
    "img_url": "test.png",
    "description": "건조함 없이 모공까지 깨끗하게 세정해주며, 자극이 적고 효과적으로 피부를 진정시켜주어 문제성 피부 관리에도 적합한 딥 클렌징 마스크",
    "price": [["60 mL", 53000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "트리트먼트 & 마스크"
    ...
    "properties" : [
      ...
      {"type": "주요 성분", "values": ["카모마일", "티 트리 리프", "이브닝 프림로즈"]}
    ]
  },
  {
    "title": "페뷸러스 페이스 오일",
    "img_url": "test.png",
    "description": "정화 작용의 식물 추출물이 들어있어 혼잡한 피부를 정리하고 밸런스를 잡아주는 페이셜 오일",
    "price": [["25 mL", 67000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "트리트먼트 & 마스크"
  ...
  },
  {
    ...
    "price": [["100 mL", 47000], ["200 mL", 73000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "토너"
    },
    "properties" : [
      ...
      {"type": "주요 성분", "values": ["파슬리 씨드", "라벤더", "마트리카리아꽃오일"]}
    ]
  },
  {
    ...
    "price": [["100 mL", 39000], ["200 mL", 63000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "토너"
    },
    "properties" : [
      {"type": "피부 타입", "values": ["대부분의 피부 타입", "지성", "문제성 피부"]},
      {"type": "사용감", "values": ["시원한", "깨끗한", "매트한 마무리"]},
      {"type": "주요 성분", "values": ["비터 오렌지", "위치 헤이즐", "로즈마리 리프"]}
    ]
  },
  {
    "title": "비 앤 티 밸런싱 토너",
    "img_url": "test.png",
    "description": "프로비타민 B5가 함유하여 피부의 밸런스를 잡아주는 수렴성 토너",
    "price": [["100 mL", 39000], ["200 mL", 63000]],
    "category" : {
      "level_1_category": "스킨 케어",
      "level_2_category": "토너"
    ...
    "properties" : [
      ...
      {"type": "사용감", "values": ["균형감", "상쾌함", "수분 공급", "가벼운 마무리"]},
  ...
  },
  {
    ...
    "price": [["500 mL (펌프 미포함)", 46000], ["500 mL (펌프 포함)", 47000]],
    "category" : {
    ...
    "properties" : [
      ...
      {"type": "주요 성분", "values": ["만다린", "로즈마리 리프", "시더우드 아틀라스"]}
    ]
  },
  {
    ...
    "properties" : [
      ...
      {"type": "주요 성분", "values": ["베티버뿌리오일", "비터오렌지잎/잔가지오일", "베르가모트오일"]}
    ]
  },
  {
    ...
    "price": [["75 mL", 31000], ["120 mL", 45000], ["500 mL", 120000]],
    "category" : {
      "level_1_category": "바디 & 핸드",
      "level_2_category": "핸드"
    },
  ...
  },
  {
    ...
    "img_url": "test.png",
    "description": "우수한 품질의 다마스크장미꽃오일과 피부를 부드럽게 가꿔주는 식물성 추출물을 함유해 부드러우면서 꼼꼼한 세정을 전하는 향기로운 클렌징 젤",
    "price": [["100 mL", 20000], ["500mL (펌프 미포함)", 55000], ["500 mL", 56000]],
    "category" : {
      "level_1_category": "바디 & 핸드",
      "level_2_category": "바디"
    },
  ...
  },
  {
    "title": "브레스리스",
    "img_url": "test.png",
    "description": "부드러움과 영양을 공급하는 넛트 오일 추출물과 풍부한 비타민 E성분을 함유한 바디 오일",
    "price": [["100 mL", 39000]],
    "category" : {
      "level_1_category": "바디 & 핸드",
      "level_2_category": "바디"
  ...
  },
  {
    ...
    "img_url": "test.png",
    "description": "피부 세정과 독특하고 따뜻한 풍성한 아로마로 기분을 북돋아주는 거품이 적은 클렌징 젤",
    "price": [["100 mL", 20000], ["500mL (펌프 미포함)", 55000], ["500 mL", 56000]],
    "category" : {
      "level_1_category": "바디 & 핸드",
      "level_2_category": "바디"
  ...
  },
  {
    ...
    "price": [["100 mL", 39000], ["500 mL", 120000]],
    "category" : {
      "level_1_category": "바디 & 핸드",
      "level_2_category": "바디"
    },
  ...
  },
  {
    "title": "데오도란트",
    "img_url": "test.png",
    "description": "징크리시놀리에이트 및 상쾌한 에센셜 오일 블렌드가 함유된 스프레이 타입의 남녀 공용 데오도란트",
    "price": [["50 mL", 37000]],
    "category" : {
      "level_1_category": "바디 & 핸드",
    ...
    "properties" : [
      {"type": "향", "values": ["그린", "시트러스", "상쾌함"]},
      {"type": "효과", "values": ["편리하고 가벼운 스프레이로 겨드랑이 냄새를 완화해줍니다"]},
      {"type": "주요 성분", "values": ["제라늄 리프", "만다린", "베르가못"]}
    ]
  },
  {
    "title": "허벌 데오도란트",
    "img_url": "test.png",
    "description": "징크리시놀리에이트와 피부를 편안하게 해주는 에센셜 오일이 함유된 스프레이 타입의 데오도란트",
    "price": [["50 mL", 37000]],
    "category" : {
      "level_1_category": "바디 & 핸드",
      "level_2_category": "퍼스널 케어"
    ...
    "properties" : [
      ...
      {"type": "효과", "values": ["편리하고 가벼운 스프레이로 겨드랑이 냄새를 완화해줍니다"]},
      {"type": "주요 성분", "values": ["살비아 오일", "징크리시놀리에이트", "버지니아풍년화수"]}
    ]
  },
  {
    "title": "샴푸",
    ...
    "price": [["100 mL", 20000], ["500mL (펌프 미포함)", 54000], ["500 mL", 55000]],
    "category" : {
      "level_1_category": "헤어",
      "level_2_category": "샴푸"
    },
    "properties" : [
      {"type": "헤어 타입", "values": ["가는 모발", "중간 모발", "거친 모발", "건조한 모발"]},
      {"type": "향", "values": ["시트러스", "흙내음", "우디"]},
      {"type": "주요 성분", "values": ["베르가못 라인드", "프랑킨센스", "시더 아틀라스"]}
    ]
  },
  {
    "title": "볼류마이징 샴푸",
    "img_url": "test.png",
    "description": "폴리쿼터늄-67이 모근 사이의 모발을 분리해 모발이 힘있고 풍성해지도록 도와주는 볼륨 샴푸",
    "price": [["500 mL", 55000]],
    "category" : {
      "level_1_category": "헤어",
      "level_2_category": "샴푸"
    ...
    "properties" : [
      ...
      {"type": "향", "values": ["민트", "허브"]},
      {"type": "주요 성분", "values": ["회향유", "페퍼민트 리프", "로즈마리 리프"]}
    ]
  },
  {
    "title": "컨디셔너",
    "img_url": "test.png",
    "description": "아미노산을 풍부하게 함유하여 연약하고 가는 모발과 염색 모발을 포함한 대부분의 모발 타입을 부드럽고 촉촉하게 가꿔주며 머릿결을 향기롭고 상쾌하게 가꿔주는 영양이 풍부한 컨디셔너",
    "price": [["100 mL", 20000], ["500mL (펌프 미포함)", 54000], ["500 mL", 55000]],
    "category" : {
      "level_1_category": "헤어",
    ...
    "properties" : [
      {"type": "헤어 타입", "values": ["가는 모발", "연약한 모발", "염색 모발을 포함한 다양한 모발 타입"]},
      {"type": "향", "values": ["시트러스", "흙내음", "우디"]},
      {"type": "주요 성분", "values": ["베르가못 라인드", "프랑킨센스", "시더 아틀라스"]}
    ]
  },
  {
    ...
    "img_url": "test.png",
    "description": "보태니컬 오일과 수분을 공급해주는 식물 추출물이 함유하고 있어 두피를 보호하고 진정시켜주는 오일 트리트먼트",
    "price": [["25 mL", 41000]],
    "category" : {
      "level_1_category": "헤어",
  ...
  },
  {
    "title": "프톨레미 아로마틱 캔들",
    "img_url": "test.png",
    "description": "시더, 사이프러스 그리고 베티버 노트가 어우러져 고대 숲을 연상시키는 아로마 향초. (*안전기준 적합확인 신고번호: CB20-26-1353 / 제품에 표기되어 있는 사용방법과 사용상 주의사항을 준수해 주시기 바랍니다.",
    "price": [["300g", 130000]],
    "category" : {
      "level_1_category": "홈",
      "level_2_category": "홈"
    ...
    "properties" : [
      ...
      {"type": "크기 및 연소 시간", "values": ["지름 86 mm/3.4” x 높이 104 mm/4.1”, 연소시간 약 55-65시간"]},
  ...
  },
  {
    "title": "아가니스 아로마틱 캔들",
    "img_url": "test.png",
    "description": "카다멈과 미모사 그리고 은은한 토바코가 어우러져 탕헤르 분위기를 떠오르게 하는 아로마 향초. (*안전기준 적합확인 신고번호: CB20-26-1355 / 제품에 표기되어 있는 사용방법과 사용상 주의사항을 준수해 주시기 바랍니다.",
    "price": [["300g", 130000]],
    "category" : {
      "level_1_category": "홈",
      "level_2_category": "홈"
  ...
  },
  {
    "title": "칼리푸스 아로마틱 캔들",
    "img_url": "test.png",
    "description": "프랑킨센스, 과이악우드, 상쾌한 시소 노트가 어우러져 제례 의식을 떠올리는 아로마 향초. (*안전기준 적합확인 신고번호: CB20-26-1354 / 제품에 표기되어 있는 사용방법과 사용상 주의사항을 준수해 주시기 바랍니다.)",
    "price": [["300g", 130000]],
    "category" : {
      "level_1_category": "홈",
      "level_2_category": "홈"
  ...
  },
  {
    "title": "이솝: 더 북",
    "img_url": "test.png",
    "description": "336 페이지에 달하는 우리의 첫 번째 도서가 린넨 양장본으로 리졸리 뉴욕 출판사에서 출간됩니다. 제품 제조에서 공간 디자인, 초창기부터 현재에 이르는 이솝의 지난 30여년간을 담은 연대기가 뛰어난 사진과 아카이브 이미지와 함께 기록되었습니다.",
    ...
    "properties" : [
      {"type": "어울리는 대상", "values": ["디자인 매니아", "호기심 많은 독자", "예술 애호가"]},
      {"type": "주요 참여자", "values": ["데니스 파피티스와 제니퍼 다운 공저", "야마모토 유타카 사진"]}
    ]
  },
